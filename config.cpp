...
{
	#include "traders\EXILE\ArsenalEXILE.hpp"
	#include "traders\MAS\VehiclesMAS.hpp"
	#include "traders\CUP\ArsenalCUP.hpp"
}
class CfgExileCustomCode 
{
	...
	*/
			...
			ExileClient_gui_inventory_event_onSlotDoubleClick = "overrides\ExileClient_gui_inventory_event_onSlotDoubleClick.sqf";
			...
			ExileClient_system_lootManager_thread_spawn = "overrides\ExileClient_system_lootManager_thread_spawn.sqf";
			ExileServer_object_player_event_onMpKilled = "overrides\ExileServer_object_player_event_onMpKilled.sqf";
			ExileClient_object_player_event_onKilled = "overrides\ExileClient_object_player_event_onKilled.sqf";
			ExileClient_gui_xm8_slide_apps_onOpen = "apps\ExileClient_gui_xm8_slide_apps_onOpen.sqf";
	...
	class Bikes
	{
		...
		class Actions
		{
			...
			class Scrap: ExileAbstractAction
			{
				title = "Scrap Bike";
				condition = "true";
				action = "execVM 'custom\ScrapBike.sqf';";
			};
		};
	};
...
class CfgTraderCategories 
{
	...
	#include "traders\MAS\TraderCategoriesMAS.hpp"
	#include "traders\CUP\TraderCategoriesCUP.hpp"
};
...
class CfgTraders
{
	...
	class Exile_Trader_Armory
	{
		...
		"CUPPistolAmmo",
			...
			"CUPSniperRifleAmmo",
			"CUPGrenadeLauncherAmmo",
			"PointerAttachments",
			"OpticAttachments",
			"MuzzleAttachments",
			"BipodAttachments",
			"CUPPistolAttachments",
			"CUPSMGAttachments",
			"CUPRifleAttachments",
			"CUPLightMachineGunAttachments",


			"CUPSniperRifleAttachments"
		};
	};
	...
	class Exile_Trader_CommunityCustoms
	{
		...
		categories[] =
		{
			"BlackMarketLightMachineGuns",
			"BlackMarketSniperRifles",
		//	"BlackMarketCUPSniperRifles",
			"BlackMarketAmmunition",
		//	"BlackMarketCUPAmmo",
			"CUPSniperRifleAttachments",

			"BlackMarketCUPExplosives"
		};
	};
